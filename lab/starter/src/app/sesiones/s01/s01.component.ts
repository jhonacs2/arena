 ...
 *
 * La clase ya está completa. Tu trabajo está en `s01.component.html`:
 * buscá `TODO(S1)`.
 *
 * TODO(S1): falta algo en este `@Component` para que `[(ngModel)]` funcione.
 */
@Component({
  selector: 'app-s01',
  standalone: true,
...
export class S01Component {
  ...
  protected agregar(): void {
    ...
    // inmutabilidad del curso, y en S3 va a ser la diferencia entre que la
    // vista se actualice y que no.
